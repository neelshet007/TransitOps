  ...
  return (
    <div className="space-y-6 select-none">
      <div>
        ...
        <p className="text-xs text-text-secondary mt-0.5">Route dispatch tracking registers</p>
      </div>
      ...
      >
        <div className="p-4 bg-accent-green/10 rounded-full text-accent-green mb-4">
          <Compass size={32} />
        </div>
        <h3 className="text-sm font-semibold text-white">Trip Dispatch Template</h3>
