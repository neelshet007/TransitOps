...
export default function VehiclesPage() {
  return (
    <div className="space-y-6 select-none">
      <div>
        <h2 className="text-xl font-bold text-white tracking-tight">Vehicles Directory</h2>
        <p className="text-xs text-text-secondary mt-0.5">
          Asset registers and classification models
        </p>
      </div>
      ...
      >
        ...
        <h3 className="text-sm font-semibold text-white">Vehicles Database Template</h3>
